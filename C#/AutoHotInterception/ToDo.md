...
the `w` would already be in the text editor.<br>
...
When a Subscribe or Unsubscribe call is made, the filter is turned off before the sub/unsub, and then turned on again afterwards.<br>
This seems un-necesarry, and could result in some blocked input "leaking" through.<br>
